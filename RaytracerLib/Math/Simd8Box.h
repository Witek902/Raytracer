...
public:
    ...
    Box_Simd8(const Box& box0, const Box& box1, const Box& box2, const Box& box3,
        ...
        , max(box0.max, box1.max, box2.max, box3.max, box4.min, box5.min, box6.min, box7.min)
    { }

    // build SIMD box from 8 boxes
    explicit Box_Simd8(const Box* boxes)
