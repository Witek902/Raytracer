 ...
 */
class RT_ALIGN(32) Vector2_Simd8
{
public:
    Vector8 x;
    Vector8 y;

    Vector2_Simd8() = default;
    Vector2_Simd8(const Vector2_Simd8&) = default;
    Vector2_Simd8& operator = (const Vector2_Simd8&) = default;

    RT_FORCE_INLINE Vector2_Simd8(const Vector8& x, const Vector8& y)
        : x(x), y(y)
    { }

    // splat single 3D vector
    RT_FORCE_INLINE explicit Vector2_Simd8(const Vector4& v)
    {
    ...
    RT_FORCE_INLINE Vector2_Simd8(const Vector4& v0, const Vector4& v1, const Vector4& v2, const Vector4& v3,
    ...
    RT_FORCE_INLINE static Vector2_Simd8 One()
    {
        return
        {
            Vector8::Splat(1.0f),
    ...
    RT_FORCE_INLINE Vector2_Simd8 operator + (const Vector2_Simd8& rhs) const
    {
    ...
    RT_FORCE_INLINE Vector2_Simd8 operator * (const Vector8& rhs) const
    {
        return { x * rhs, y * rhs };
    }
    ...
    RT_FORCE_INLINE Vector2_Simd8 operator * (const float rhs) const
    {
        return { x * rhs, y * rhs };
    }
    ...
    RT_FORCE_INLINE Vector2_Simd8& operator += (const Vector2_Simd8& rhs)
    {
        x += rhs.x;
        y += rhs.y;
        return *this;
    ...
    RT_FORCE_INLINE Vector2_Simd8& operator *= (const float rhs)
    {
        x *= rhs;
        y *= rhs;
        return *this;
    ...
    RT_FORCE_INLINE static Vector2_Simd8 FastReciprocal(const Vector2_Simd8& v)
    {
        return
        {
    ...
    RT_FORCE_INLINE static Vector2_Simd8 MulAndAdd(const Vector2_Simd8& a, const Vector2_Simd8& b, const Vector2_Simd8& c)
    {
        return
        {
    ...
    RT_FORCE_INLINE static Vector2_Simd8 MulAndSub(const Vector2_Simd8& a, const Vector2_Simd8& b, const Vector2_Simd8& c)
    {
        return
        {
    ...
    RT_FORCE_INLINE static Vector2_Simd8 NegMulAndAdd(const Vector2_Simd8& a, const Vector2_Simd8& b, const Vector2_Simd8& c)
    {
        return
        {
    ...
    RT_FORCE_INLINE static Vector2_Simd8 NegMulAndSub(const Vector2_Simd8& a, const Vector2_Simd8& b, const Vector2_Simd8& c)
    {
        return
        {
    ...
    // 2D dot product
    RT_FORCE_INLINE static Vector8 Dot(const Vector2_Simd8& a, const Vector2_Simd8& b)
    {
    ...
    RT_FORCE_INLINE static Vector2_Simd8 Min(const Vector2_Simd8& a, const Vector2_Simd8& b)
    {
        return { Vector8::Min(a.x, b.x), Vector8::Min(a.y, b.y) };
    }

    RT_FORCE_INLINE static Vector2_Simd8 Max(const Vector2_Simd8& a, const Vector2_Simd8& b)
    {
